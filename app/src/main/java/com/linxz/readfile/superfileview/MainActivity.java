...
import com.linxz.readfile.R;
import com.linxz.readlib.FileDisplayActivity;
...
public class MainActivity extends AppCompatActivity {
            ...
            public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
                holder.itemView.findViewById(R.id.item_root).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        FileDisplayActivity.launch(MainActivity.this, getFilePath(5),null,"电子保单.pdf");
                    }
                });
    ...
    private String getFilePath(int position) {
        ...
        switch (position) {
            ...
            case 5:
                path = "/storage/emulated/0/正规电子发票2.pdf";
                break;
        }
        return path;
    }
